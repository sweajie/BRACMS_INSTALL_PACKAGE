...
<div class="install-box">
    ...
    <form class="layui-form layui-form-pane" action="" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w200">
                <input type="text" class="layui-input" name="database[DB_HOST]" value="{{config('database.connections.mysql.host')}}" lay-verify="title" value="127.0.0.1">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w200">
                <input type="text" class="layui-input" name="database[DB_PORT]" value="{{config('database.connections.mysql.port')}}" lay-verify="title" value="3306">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w200">
                <input type="text" class="layui-input" name="database[DB_DATABASE]"  value="{{config('database.connections.mysql.database')}}"  lay-verify="title">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w200">
                <input type="text" class="layui-input" name="database[DB_USERNAME]"  value="{{config('database.connections.mysql.username')}}" lay-verify="title">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w200">
                <input type="password" class="layui-input"  name="database[DB_PASSWORD]"  value="{{config('database.connections.mysql.password')}}" lay-verify="title">
            </div>
    ...
    <form class="layui-form layui-form-pane" action="/?step=4" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">管理员账号最少5位</div>
        </div>
        <div class="layui-form-item">
